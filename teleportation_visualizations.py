...
from src.teleport import linear_sqp, al_method, penalty_method, identity
...
def run_methods(
    ...
    t0 = time.perf_counter()
    results = {
        "GDtp": (gdtp_time, gdtp_fval, gdtp_x_list),
        "ALtp": (altp_time, altp_fval, altp_x_list),
        "PENtp": (pentp_time, pentp_fval, pentp_x_list),
